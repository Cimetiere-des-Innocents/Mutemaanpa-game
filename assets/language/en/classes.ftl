...
Rogue = Rogue
    .desc = Deception, Stealth, Murder... What else can you expect from them?
...
Ranger = Ranger
    .desc = Uses bows to their own moral compass.

Paladin = Paladin
    .desc = Protects the weakness, everyone's favorite knight.
...
Mechanic = Mechanic
    .desc = Build advanced armours & weapons to fight in their stead.

Wizard = Wizard
    .desc = Spell to attack and anti-attack.

Alchemist = Alchemist
    .desc = Change the world through tweaking the environment.
